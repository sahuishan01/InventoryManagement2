...
import com.example.inventorymanagement.DataModal;
import com.example.inventorymanagement.SearchResultsRVAdapter;
...
public class textCamCapture extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchResultsRVAdapter = new SearchResultsRVAdapter(dataModalArrayList, textCamCapture.this);

        // layout manager for our recycler view.
        LinearLayoutManager manager = new LinearLayoutManager(textCamCapture.this, LinearLayoutManager.HORIZONTAL, false);
    ...
    private void getResults() {
        ...
        labeler.processImage(image).addOnSuccessListener(new OnSuccessListener<List<FirebaseVisionImageLabel>>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(textCamCapture.this, "Fail to detect image..", Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void searchData(String searchQuery) {
        String apiKey = "d2fbd93393e88b29e90d00f68d6958b43fa6f8724e4eb1e7cf569f0a9bc7ea05";
        ...
        RequestQueue queue = Volley.newRequestQueue(textCamCapture.this);
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                // displaying error message.
                Toast.makeText(textCamCapture.this, "No Result found for the search query..", Toast.LENGTH_SHORT).show();
            }
        });
